...
const METODOS = [
  ...
  { key: 'tarjeta_debito',  label: 'Débito',        icono: CreditCard,     color: 'text-blue-600'    },
  { key: 'tarjeta_credito', label: 'Crédito',       icono: CreditCard,     color: 'text-purple-600'  },
...
export default function Caja() {
  ...
  return (
    <div className="h-full overflow-y-auto p-3 sm:p-6 pb-6 space-y-6">
      {error && (
...
function PanelCajaCerrada({ perfil, onAbrir, setError }) {
  ...
  return (
    <div className="flex items-start justify-center pt-6">
      <div className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 w-full max-w-sm shadow-sm text-center">
        <div className="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-4">
          <Lock size={28} className="text-slate-400" />
        </div>
        <h2 className="text-lg font-bold text-slate-800 mb-1">Caja cerrada</h2>
        <p className="text-sm text-slate-400 mb-6">Abrí la caja para comenzar el turno.</p>
