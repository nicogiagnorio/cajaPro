...
const MODULOS = [
  ...
  { icono: CalendarDays, nombre: "Turnos",         descripcion: "Agenda y horarios por profesional",             color: "bg-sky-50 text-sky-600",       ruta: "/app/turnos",     moduloKey: "turnos"   },
        ...
        {MODULOS
          ...
          .map(({ icono: Icono, nombre, descripcion, color, ruta }) => (
            <div
              ...
              className="bg-white rounded-2xl border border-slate-200 p-6 overflow-hidden transition-all hover:border-blue-200 hover:shadow-md active:scale-[0.98] cursor-pointer group"
            >
