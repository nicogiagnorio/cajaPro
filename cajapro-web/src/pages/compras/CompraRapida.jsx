...
export default function CompraRapida() {
  ...
  return (
    <div className="h-full overflow-y-auto py-4">
      <div className="bg-white rounded-2xl border border-slate-200 p-5 sm:p-8 w-full max-w-xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <h2 className="font-semibold text-slate-800">Compra rápida</h2>
          ...
          <div className="space-y-3">
            ...
            <div>
              <p className="text-sm font-medium text-slate-700 mb-2">
                {pagada ? 'Método de pago' : 'Método de pago previsto'}
              </p>
