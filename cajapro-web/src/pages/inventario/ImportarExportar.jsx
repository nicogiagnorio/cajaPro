    ...
    <div className="space-y-8 pb-8">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
        <div className="px-4 sm:px-6 py-4 border-b border-slate-100 flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            <Button variante="secundario" onClick={plantillaProductos} className="flex-1 sm:flex-none">
              <FileSpreadsheet size={15} /> Plantilla
            </Button>
            <Button variante="secundario" onClick={() => exportarProductos(datos.productos)} className="flex-1 sm:flex-none">
        ...
        <div className="px-4 sm:px-6 py-5 space-y-4">
          ...
          {!previaProds && (
            <div>
              ...
              >
                <Upload size={24} />
                <span className="text-sm font-medium">Tocá para importar Excel</span>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
        <div className="px-4 sm:px-6 py-4 border-b border-slate-100 flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            <Button variante="secundario" onClick={plantillaProveedores} className="flex-1 sm:flex-none">
              <FileSpreadsheet size={15} /> Plantilla
            </Button>
            <Button variante="secundario" onClick={() => exportarProveedores(datos.proveedores)} className="flex-1 sm:flex-none">
              <Download size={15} /> Exportar
            </Button>
          </div>
        </div>
