...
export default function CalendarioSemanal() {
  ...
  const [filtroProfs,     setFiltroProfs]     = useState([])
    ...
    <div className="flex flex-col gap-4 h-full">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        {profesionales.length > 1 && (
          <div className="w-full sm:w-auto sm:ml-auto flex items-center gap-1.5 flex-wrap overflow-x-auto">
            <button
              onClick={() => setFiltroProfs([])}
              className={`px-3 py-1 rounded-full text-xs font-medium transition-colors border flex-shrink-0 ${
      ...
      {turnoActivo && (
        ...
        >
          <div className="bg-white rounded-t-2xl sm:rounded-2xl shadow-xl p-6 w-full sm:w-80 space-y-4">
