    ...
    <div>
      ...
      <div className="flex flex-wrap gap-3 mb-4 items-center">
        ...
        <select
          ...
          className="text-sm border border-slate-300 rounded-lg px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-400 bg-white"
        >
          ...
          <div>
            ...
            <div className="mt-3">
              ...
              <p className="text-xs text-slate-400 mt-1">
                Usado al emitir facturas A/B en ARCA. El precio de venta ya incluye el IVA.
              </p>
            </div>
          </div>
