...
import {
  ...
  ShoppingBag, CalendarDays, ChevronDown, Check,
} from 'lucide-react'
...
export default function Reportes() {
  ...
  async function cargar() {
    ...
    let qV = supabase.from('ventas').select('id, total, tipo, metodo_pago, fecha').eq('comercio_id', perfil.comercio_id).eq('estado', 'completada')
  ...
  return (
    <div className="p-3 sm:p-6 space-y-5 pb-10 overflow-y-auto h-full">
